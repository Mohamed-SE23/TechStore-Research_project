...
const ProductsCard = ({ id, img, title, description, price, store, owner, location, whatsappNum, confirmed }) => {
  ...
  return (
    <div className="max-w-sm min-h-fit rounded overflow-hidden shadow-lg bg-white transition-shadow duration-300 ease-in-out">
      {/* Image Section */}
