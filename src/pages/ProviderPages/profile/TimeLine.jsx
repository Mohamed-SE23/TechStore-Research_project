...
const TimeLine = ({StoreName, bio}) => {
  return (
    <div className='flex flex-col justify-center items-center bg-gradient-to-b from-gray-200 to-white mb-20'>
      <div className='relative max-w-4xl w-full h-96 flex justify-center sm:h-72'>
        <img src={coverTimeLine} alt="cover photo" className='object-cover w-full h-full rounded-b-lg' />
