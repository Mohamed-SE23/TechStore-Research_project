  ...
  return (
    <div className='max-w-[14rem] w-full flex flex-col items-center justify-center bg-white mx-10 rounded shadow-lg'>
      <div className='relative flex justify-center w-full'>
        <img src={coverTimeLine} alt="store-innerImage" className='rounded-t h-28 w-full object-cover' />
        <img src={laptop} alt="store-innerImage" className='absolute w-28 h-28 rounded-full object-cover border-2 -bottom-16' />
      </div>
      <div className='mt-20 flex flex-col gap-1 justify-center items-center w-full px-4'>
        <h3 className='font-semibold text-lg text-center break-words'>Store Name</h3>
        <p className='text-center px-4 break-all'>Store description</p>
      </div>
      <div className='my-4'>
        <button
            type='button'
